...
def GraSP_fetch_data(dataloader, num_classes, samples_per_class):
    ...
    while True:
        _, inputs, targets = next(dataloader_iter)
...
def GraSP(net, ratio, train_dataloader, device, max_gpu_usage, num_classes=10, samples_per_class=25, num_iters=1, T=200, reinit=True):
    eps = 1e-10
    keep_ratio = 1-ratio
    old_net = net
    ...
    return keep_masks, max_gpu_usage
